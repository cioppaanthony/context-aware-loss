...
- Function to [extract the features](https://github.com/SilvioGiancola/SoccerNetv2-DevKit/tree/main/Features on new videos) for your own videos, which was an issue in this version. 
